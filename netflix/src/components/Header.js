            ...
            </Link>
            {
                user && (
                    <div className='flex items-center gap-3'>
                        <button onClick={toggleHandler} className='bg-red-800 hover:bg-red-700 text-white px-4 py-2 rounded text-sm font-medium transition-colors duration-200'>{toggle ? "Home" : "Search Movie"}</button>
                        ...
                        <div className='relative' ref={dropdownRef}>
                            ...
                            >
                                ...
                                <h1 className='text-sm font-medium text-white hidden sm:block'>{user.fullName}</h1>
                                {dropdownOpen 
                            ...
                            >
                                ...
                                {/* User Info Section */}
                                <div className='px-4 py-3 flex items-center gap-3' style={{ borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                                    ...
                                    <div className='overflow-hidden'>
                                        ...
                                        <p className='text-gray-400 text-xs truncate'>{user.email || 'Netflix User'}</p>
                                    </div>
                                </div>
